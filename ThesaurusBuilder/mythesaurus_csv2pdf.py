...
- This code takes a CSV file with 3 named columns:
    - Generic_controlled_vocabulary
    - Specific_controlled_vocabulary
    - Aliases
- and turn it into a pretty PDF, 
  displaying a two-levels controlled vocabulary and its aliases
...
reference_text = "<font size=6 color='gray'>generated from csv with https://github.com/pmartinolli/MyThesaurus/blob/master/files/ThesaurusBuilder/mythesaurus_csv2pdf.py</font>"
